...
const inputCls =
  "rounded-lg border border-border bg-bg-surface px-3.5 py-3 text-[15px] text-text-primary placeholder:text-text-muted transition-colors focus:border-defend focus:outline-none focus:ring-[3px] focus:ring-defend/10";
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-[14px] rounded-[14px] border border-border bg-bg-card p-6">
      <div className="flex flex-col gap-1.5">
        <label className="text-[13.5px] font-semibold text-text-secondary" htmlFor="w-title">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex flex-col gap-1.5">
          <label className="text-[13.5px] font-semibold text-text-secondary" htmlFor="w-name">
            작성자 <span className="text-attack">*</span>
          </label>
          <input id="w-name" required placeholder="이름/닉네임" className={inputCls} />
        </div>
        <div className="flex flex-col gap-1.5">
          <label className="text-[13.5px] font-semibold text-text-secondary" htmlFor="w-contact">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-[13.5px] font-semibold text-text-secondary" htmlFor="w-body">
      ...
      <button
        type="submit"
        className="mt-1 rounded-lg bg-attack px-6 py-3 font-mono text-[14.5px] font-semibold text-white transition-all hover:bg-attack-dark hover:shadow-[0_0_28px_rgba(255,70,85,0.35)] active:scale-[0.98]"
      >
        문의 등록하기
      </button>
    </form>
