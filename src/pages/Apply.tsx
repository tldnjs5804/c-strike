        ...
        <div className="mx-auto max-w-[640px] px-6 sm:px-8">
          {submitted ? (
            <div className="animate-page-in corner-marks flex flex-col items-center gap-3 border border-border bg-bg-card px-5 py-16 text-center">
              ...
              <h3 className="font-serif text-[22px] font-bold text-text-primary">신청이 접수되었습니다</h3>
            ...
            <>
              <div className="mb-7 flex items-start gap-3 border border-amber/30 border-l-2 border-l-amber bg-bg-card px-4 py-3.5">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-[18px]">
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="name">
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="student-id">
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="dept">
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="phone">
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="email">
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="team">
                    팀 구성 (선택)
                  </label>
                  <textarea
                    id="team"
                ...
                <div className="flex flex-col gap-2">
                  <label className="font-mono text-[12px] font-semibold uppercase tracking-wide text-text-secondary" htmlFor="note">
                    하고 싶은 말 (선택)
                  </label>
